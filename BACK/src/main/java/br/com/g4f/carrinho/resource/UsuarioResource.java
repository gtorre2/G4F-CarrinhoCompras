...
import br.com.g4f.carrinho.security.JWT.JwtProvider;
import br.com.g4f.carrinho.service.UsuarioService;
import br.com.g4f.carrinho.vo.request.LoginForm;
import br.com.g4f.carrinho.vo.response.JwtResponse;
...
public class UsuarioResource {
    ...
    public ResponseEntity<JwtResponse> login(@RequestBody LoginForm loginForm) {
        ...
        try {
            ...
            User user = usuarioService.findOne(userDetails.getUsername());
